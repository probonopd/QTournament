...
QT_MOC_LITERAL(4, 43, 7)
    ...
    "QTournament::TeamMngr\0newTeamCreated\0"
    "\0Team\0newTeam\0"
};
...
void QTournament::TeamMngr::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->newTeamCreated((*reinterpret_cast< const Team(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (TeamMngr::*_t)(const Team & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&TeamMngr::newTeamCreated)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void QTournament::TeamMngr::newTeamCreated(const Team & _t1)
{
