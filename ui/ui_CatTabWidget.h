...
public:
    ...
    void setupUi(QDialog *CatTabWidget)
    {
        ...
        horizontalGroupBox = new QGroupBox(CatTabWidget);
        ...
        listWidget_2 = new QListWidget(horizontalGroupBox);
        listWidget_2->setObjectName(QStringLiteral("listWidget_2"));

        horizontalLayout_5->addWidget(listWidget_2);

        verticalGroupBox_2 = new QGroupBox(horizontalGroupBox);
        ...
        listWidget = new QListWidget(horizontalGroupBox);
...
"for each round", 0));
        ...
        horizontalGroupBox->setTitle(QApplication::translate("CatTabWidget", "Player Pairs", 0));
