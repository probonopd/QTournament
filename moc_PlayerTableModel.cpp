...
const QMetaObject PlayerTableModel::staticMetaObject = {
    { &QAbstractTableModel::staticMetaObject, qt_meta_stringdata_PlayerTableModel.data,
      qt_meta_data_PlayerTableModel,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_PlayerTableModel.stringdata))
        return static_cast<void*>(const_cast< PlayerTableModel*>(this));
